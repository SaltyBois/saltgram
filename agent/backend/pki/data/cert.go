...
var (
	ROOT_CN = internal.GetEnvOrDefault("PKI_ROOT_CN_AGENT", "AgentRootCA")
)
...
var trustedDNS = []string{"localhost", "saltgram-auth", "saltgram-api-gateway", "saltgram-contents", "saltgram-email", "saltgram-users", "saltgram-webserver", "saltgram-admin", "saltgram-agent"}
