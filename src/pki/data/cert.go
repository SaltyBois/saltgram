...
var trustedDNS = []string{"localhost", "saltgram-auth", "saltgram-api-gateway", "saltgram-contents", "saltgram-email", "saltgram-users", "saltgram-webserver", "saltgram-admin", "saltgram-notification"}
