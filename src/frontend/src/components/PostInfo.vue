  ...
  <div>
    ...
    <transition name="slide" appear>
      ...
      <v-layout class="modal"
        ...
        <v-btn class="other-buttons my-2"
               @click="showDialog = false">Unfollow @{{username}}</v-btn>
        <v-btn class="other-buttons my-2"
               v-if="myProfile"
               @click="showDialog = false">Delete post</v-btn>
        <!-- TODO : Think about this last commented button-->
<!--        <v-btn class="mute-button my-2"-->
<!--               @click="showDialog = false">Go to post</v-btn>-->
